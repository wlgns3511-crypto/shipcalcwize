          ...
          "@graph": [
            {
              ...
              "potentialAction": {
                "@type": "SearchAction",
                "target": "https://shipcalcwize.com/search?q={search_term_string}",
